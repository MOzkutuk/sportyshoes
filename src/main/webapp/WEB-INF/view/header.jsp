      ...
      <header id="nav" class="sticky-nav-2">
          <nav class="w-container">
              <ul role="list" class="nav-grid w-list-unstyled">
                  ...
                  <li>
                      <a href="showproducts" class="nav-link">Products</a>
                  </li>
                  <li>
                      <a href="signup" class="button w-button">Sign up</a>
                  </li>
                  <li>
                      <a href="showCart" class="nav-logo-link"><img src="images/cart_logo.jpg" class="nav-logo" alt="hey"></a>
                  </li>
                  <li>
                      <a class="button w-button">Hi ${customer.name}</a>
                  </li>
              </ul>
          </nav>
      </header>
